...
public class Program {
    public static void main(String args[]){
        ...
        for (int i = 0 ; i < num_of_rovers ; i++ ){
             ...
             res_arr[i] = movement_of_rover(width, height, rover_pos_arr, rover_mov);
    ...
    //Perform all the moves that are supposed to be done by the Rover
    public static String movement_of_rover(int width, int height, String[] rover_pos_arr, String rover_mov){
        ...
        return curr_rover_x + " " + curr_rover_y + " " + rovev_dir;
    }

    //Check if Rover gets out of the plateau
